...
import generate.tostring.element.MethodElement;
...
public class GenerateToStringUtils {
    ...
    private static Logger log = Logger.getLogger(GenerateToStringUtils.class);
    ...
    /**
     * Filters the list of fields from the class with the given parameters from the {@link generate.tostring.config.Config config} settings.
     *
     ...
     */
    public static PsiField[] filterAvailableFields(Project project, PsiAdapter psi, PsiElementFactory elementFactory, PsiClass clazz, FilterPattern pattern) {
        ...
        for (PsiField field : fields) {
            FieldElement fe = ElementFactory.newFieldElement(project, field, elementFactory, psi);
     ...
     */
    public static PsiMethod[] filterAvailableMethods(PsiAdapter psi, PsiElementFactory elementFactory, PsiClass clazz, FilterPattern pattern) {
