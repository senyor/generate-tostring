...
public class TemplateResourceLocator {
    ...
    private static final String DEFAULT_CONCAT = "/generate/tostring/template/DefaultConcatMember.vm";
    private static final String DEFAULT_CONCAT_SUPER = "/generate/tostring/template/DefaultConcatMemberSuper.vm";
    private static final String DEFAULT_BUFFER = "/generate/tostring/template/DefaultBuffer.vm";
    private static final String DEFAULT_BUILDER = "/generate/tostring/template/DefaultBuilder.vm";
    private static final String DEFAULT_BUILDER_ANNOTATION = "/generate/tostring/template/DefaultBuilderWithAnnotation.vm";
    private static final String DEFAULT_TOSTRINGBUILDER = "/generate/tostring/template/DefaultToStringBuilder.vm";
